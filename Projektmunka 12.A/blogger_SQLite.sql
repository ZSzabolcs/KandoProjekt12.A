...
DELETE FROM user WHERE "username" = 'az3';
...
DELETE FROM blog WHERE "blog_username" = 'az3';
...
DROP TABLE IF EXISTS "az1__chats_page";
DROP TABLE IF EXISTS "az3__chats_page";

CREATE TABLE IF NOT EXISTS "az3__chats_page" (
"chat_ser_num" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
"from_who" VARCHAR(30) NOT NULL,
"message_text" TEXT NOT NULL,
"message_date" DATE NOT NULL,
CONSTRAINT FK_az3_page FOREIGN KEY (from_who)
REFERENCES user(username)
);